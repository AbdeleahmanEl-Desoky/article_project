                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                            ...
                            <form method="POST" action="{{ route('admin.articles.details.store',$id) }}"enctype="multipart/form-data">
                                @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <label >title_en <span class="required">*</span></label>
                                    <input type="text" id="title_en" name="title_en" class="form-control @error('title') is-invalid @enderror">
                                    @error('title')
