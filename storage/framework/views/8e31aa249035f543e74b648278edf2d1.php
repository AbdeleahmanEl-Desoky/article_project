            ...
            <div class="menu_section">
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-desktop"></i> Site Settings <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="<?php echo e(route('admin.contacts.index')); ?>">Contact US</a></li>
                            <li><a href="<?php echo e(route('admin.abouts.index')); ?>">About US</a></li>
                            <li><a href="<?php echo e(route('admin.medias.index')); ?>">Media</a></li>
                            <li><a href="<?php echo e(route('admin.privacy-policy.index')); ?>">Privacy Policy</a></li>
                        </ul>
                    </li>
        ...
        <!-- /sidebar menu -->
<?php /**PATH C:\xampp\htdocs\Article_new\resources\views/admin/include/sidebar.blade.php ENDPATH**/ ?>