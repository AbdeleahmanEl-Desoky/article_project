                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                            ...
                            <form method="POST" action="<?php echo e(route('admin.articles.details.store',$id)); ?>"enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <label >title_en <span class="required">*</span></label>
                                    <input type="text" id="title_en" name="title_en" class="form-control <?php $__errorArgs = ['title'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        <label>Add link Photo <span class="required">*</span></label>
                                        <div id="inputContainer">
                                            <!-- Initial input field -->
                                            <input type="text" name="images[]" class="form-control">
                                        </div>
                                        <button type="button" id="addInputBtn">Add Input</button>
                                        <button type="button" id="removeInputBtn">Remove Input</button>
                                    </div>
                                </div>
                            </div>
...
<script>
    class FormController {
        constructor() {
            this.addInputBtn = document.getElementById("addInputBtn");
            ...
            this.removeInputBtn.addEventListener("click", this.removeInput.bind(this));
        }
        ...
        removeInput() {
            var inputs = this.inputContainer.getElementsByTagName("input");

            // Check if there's at least one input to remove
            if (inputs.length > 1) {
                // Remove the last input element
                this.inputContainer.removeChild(inputs[inputs.length - 1]);
            } else {
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Article_new\resources\views/admin/article/details/create.blade.php ENDPATH**/ ?>